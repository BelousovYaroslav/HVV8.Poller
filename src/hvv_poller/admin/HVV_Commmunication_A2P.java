 ...
 * @author yaroslav
 */
public class HVV_Commmunication_A2P extends HVV_Communication.server.HVV_Comm_Server {
    final HVV_Poller theApp;
    static Logger logger = Logger.getLogger(HVV_Commmunication_A2P.class);
    
    public HVV_Commmunication_A2P( int nServerPort, HVV_Poller app) {
        super( "A2P_SRV: ", nServerPort);
        theApp = app;
    ...
    public void processIncomingCommand( String strReqId, LinkedList lstIncomingParcel) throws Exception {
            ...
            switch( strCmd) {
                case "GET":
                    ...
                    if( strObject != null) {
                        ...
                        logger.debug( "A2P_SRV: << [" + strReqId + ";GET;" + strObject + "]");
                ...
                case "PING":
                    logger.debug( "A2P_SRV << : [" + strReqId + ";PING;" + "]");
                    nRetCode = 0;
                    theApp.m_pMainWnd.lblLastActionAdmin.setText( theApp.NiceFormatDateTime( theApp.GetLocalDate()));
        ...
        if( bGet) {
            //RESPOND
            logger.debug( "A2P_SRV: >> [ " + strReqId + ";" + nRetCode + ";" + String.format("%.3e", dblRespondValue) + "]");
            ...
            //RESPOND
            logger.debug( "A2P_SRV: >> [ " + strReqId + ";" + nRetCode + "]");
